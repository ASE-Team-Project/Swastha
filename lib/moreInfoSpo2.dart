...
class MoreInfoSpo2 extends StatefulWidget {
  const MoreInfoSpo2({Key? key}) : super(key: key);

  @override
  State<MoreInfoSpo2> createState() => _MoreInfoSpo2State();
}

class _MoreInfoSpo2State extends State<MoreInfoSpo2> {
  String timeStamp = "";
  String value = "";
  int count = 0;
  ...
  void readData() async {
    ...
    for (int i = 0; i < x.length; i++) {
      ...
      spo2.add(PastSpo2(x[i], y[i]));
      print("x " + x[i].toString());
      print("y " + y[i].toString());
      print("result:" + spo2[i].toString());
      setState(() {});
    }
    print("result:" + spo2[0].toString());
  }
