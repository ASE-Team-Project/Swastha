...
class MoreInfoSteps extends StatefulWidget {
  const MoreInfoSteps({Key? key}) : super(key: key);

  @override
  State<MoreInfoSteps> createState() => _MoreInfoStepsState();
}

class _MoreInfoStepsState extends State<MoreInfoSteps> {
  String timeStamp = "";
  String value = "";
  int count = 0;
  ...
  void readData() async {
    ...
    for (int i = 0; i < x.length; i++) {
      ...
      steps.add(PastSpo2(x[i], y[i]));
      print("x " + x[i].toString());
      print("y " + y[i].toString());
      print("result:" + steps[i].toString());
      setState(() {});
    }
    print("result:" + steps[0].toString());
  }
